...
import type { ChatPostMessageRequest, ChatPostMessageResponse } from "slack-edge";
...
function sendMessage(message: ChatPostMessageRequest): Promise<ChatPostMessageResponse> {
