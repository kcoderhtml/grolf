      ...
      },
      {
        ...
        text: {
          ...
          text: `Commits Sent Over the Last 5 Days:\n\n${barChartGenerator(
            analytics.slice(0, 5).map((analytics) => analytics.totalCommits!),
            5,
      ...
      },
      {
        ...
        text: {
          ...
          text: `New Releases Sent Over the Last 5 Days:\n\n${barChartGenerator(
            analytics.slice(0, 5).map((analytics) => analytics.totalReleases!),
            5,
            analytics.slice(0, 5).map((analytics) =>
              new Date(analytics.day!).toLocaleDateString("en-US", {
                weekday: "short",
      ...
      },
      {
        ...
        text: {
          ...
          text: `New Users Over the Last 5 Days:\n\n${barChartGenerator(
            analytics.slice(0, 5).map((analytics) => analytics.newUsers!),
            5,
            analytics.slice(0, 5).map((analytics) =>
              new Date(analytics.day!).toLocaleDateString("en-US", {
                weekday: "short",
